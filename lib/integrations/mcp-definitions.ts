...
export const MCP_DEFINITIONS: McpDefinition[] = [
...

  {
    ...
    setupSteps: [
      ...
      "Click Test Connection — the agent calls blotato_get_user against https://backend.blotato.com/v2/users/me and confirms the API key works. On success the integration goes green and 20 blotato_* tools become available to every agent on templates that wire Blotato.",
