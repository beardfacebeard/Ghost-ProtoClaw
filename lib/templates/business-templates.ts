  ...
  // ── TikTok Shop Operator ──────────────────────────────────────────────────
  {
    ...
    starterAgents: [
      ...
      },
      {
        ...
        purpose:
          "Produces AI-generated UGC content at scale using tools like MakeUGC, Arcads, and Creatify. Manages the ad clone workflow, generates 10-20 creative variations per product for testing, and maintains the UGC production pipeline that feeds both organic content and Spark Ad campaigns.",
        type: "specialist",
        systemPromptTemplate:
    ...
    starterKnowledge: [
      ...
      },
      {
        ...
        contentTemplate:
          "{{businessName}}'s Ad Clone workflow for generating creative variations at scale: STEP 1 — Source input ad (proven winner from TikTok Creative Center, competitor research, or past top performer). STEP 2 — Link to correct Product and Brand for consistency. STEP 3 — Generate 5 AI image ad variations with different creative treatments (angle changes, layout modifications, text overlay variations, compositional differences). STEP 4 — Select the strongest as 'Chosen Favorite.' STEP 5 — Round 1 editing (describe changes in natural language, AI applies). STEP 6 — Round 2 refinement. STEP 7 — Finalize approved creative. STEP 8 — Auto-resize to 9:16 (TikTok/Reels/Stories), 1:1 (feed/listings), 4:3 (web). STEP 9 — Optional video conversion for dynamic placements. BEST PRACTICES — Always start with proven winners, make each variation meaningfully different (change hooks and composition not just colors), test all 5 variations (let data decide), maintain brand consistency via brand asset table, refresh every 7-10 days to fight ad fatigue, never assume which will win."
      },
      {
        category: "custom",
